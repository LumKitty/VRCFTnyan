...
namespace VRCFTnyan
{
    internal static class VRCFTParametersStore
    {
        ...
        private static VRCFTParameterWeights _Weights = new VRCFTParameterWeights();
    ...
    internal class VRCFTParameterWeights: IEnumerable<float>
    {
        ...
        public float this[VRCFTParametersV2 param]
        {
            get
            {
                return net2bodge.Clamp(_Weights[(int)param], -1.0f, 1.0f);
            }
            set
            {
        ...
        public float this[int param]
        {
            get
            {
                return net2bodge.Clamp(_Weights[param], -1.0f, 1.0f);
            }
            set
            {
                _Weights[param] = value;
